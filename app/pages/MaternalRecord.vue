<template>
  <v-container>
    <MaternalRecordEditor
      ...
      :readOnly="readOnly"
    />
    <TitleHeader title="Maternal Record (Pre-natal)" />
    <v-data-table
      :headers="headers"
      :items="residents"
      class="elevation-2"
...
<router lang="yaml">
    path: /maternal-record
    name: maternal-record 
</router>
...
export default {
  ...
  methods: {
    fetchResidents: call("maternalrecord/fetchItems"),
    deleteResident: call("maternalrecord/removeItem"),
